...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        ...
        if mode == "manual":
            ...
            nose_px = int((nose_tip.x) * w)
            nose_py = int(nose_tip.y * h)
    ...
    if main_grid_active:
        ...
        for (r, c), item in current_subgrid.items():
            ...
            cv2.rectangle(frame, (10, FRAME_HEIGHT - 70), (FRAME_WIDTH - 10, FRAME_HEIGHT - 20), (0, 0, 0), -1)

            # Put the sentence text over the rectangle
            display_text = "Sentence: " + sentence
            cv2.putText(frame, display_text, (20, FRAME_HEIGHT - 35),
    ...
    # Display in window
    cv2.imshow("MindBoard – Live Window", frame)
